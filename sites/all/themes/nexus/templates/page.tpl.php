...
<div id="page">
  ...
  <div id="slidebox" class="flexslider">
    <ul class="slides">
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'nexus') . '/images/Mayurbhanj.jpg'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'nexus') . '/images/walle.jpg'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'nexus') . '/images/1140.png'; ?>"/>
    ...
    <div class="container">
      <div class="row">
        <div class="fcred col-sm-12">
		  ...
		  Paschim Medinipur 
		  <!--<?php print $site_name; ?></a>. <?php print t('Theme by'); ?>  <a href="http://www.devsaran.com" target="_blank">Devsaran</a>. -->
        </div>
      </div>
    </div>
  </div>
