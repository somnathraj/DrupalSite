    ...
    <header id="header" role="banner">
      ...
      <div class="top_right">
        ...
        <div class="search_block">
          ...
          <?php if (theme_get_setting('social_links', 'media_responsive_theme')): ?>
            <div class="social-icons">
             <ul>
              <li><a href="<?php print $front_page; ?>/rss.xml"><img src="<?php print base_path() . drupal_get_path('theme', 'media_responsive_theme') . '/images/rss.png'; ?>" alt="RSS Feed"/></a></li>
              <li><a href="http://www.facebook.com/<?php echo theme_get_setting('facebook_username', 'media_responsive_theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'media_responsive_theme') . '/images/facebook.png'; ?>" alt="Facebook"/></a></li>
              <li><a href="http://www.twitter.com/<?php echo theme_get_setting('twitter_username', 'media_responsive_theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'media_responsive_theme') . '/images/twitter.png'; ?>" alt="Twitter"/></a></li>
             </ul>
            </div>
          <?php endif; ?>
        </div>
    ...
    <div id="footer_wrapper" class="footer_block">
      <?php if ($page['footer_1'] || $page['footer_2'] || $page['footer_3'] || $page['footer_4']): ?> 
        <div id="footer-area" class="clearfix">
          ...
          <div class="column"><?php print render($page['footer_1']); ?></div>
          <?php endif; ?>
          <?php if ($page['footer_2']): ?>
          <div class="column"><?php print render($page['footer_2']); ?></div>
          <?php endif; ?>
          <?php if ($page['footer_3']): ?>
          <div class="column"><?php print render($page['footer_3']); ?></div>
          <?php endif; ?>
          <?php if ($page['footer_4']): ?>
          <div class="column"><?php print render($page['footer_4']); ?></div>
          <?php endif; ?>
        </div>
      <?php endif; ?>
    </div>
